...
categories:
  - AI Engineering
  - Engineering Culture
description: How AI support changed my judgment of what work is worth attempting at all
slug: ai-and-productivity
---
...
The problem: this is not the codebase where I actively develop. A big repository with many modules, it felt risky to touch it for a couple of experiments.
